...
class HomeIndex extends React.Component {
  render() {
    const siteTitle = 'Christian Mejia - Front End Engineer'
    const siteDescription = 'My portfolio site'
        ...
        <div id="main">
          <section id="one">
            <header className="major">
              <h2>
                Hello! I'm Christian, a Fullstack Developer from White Plains,
                NY that was also a designer in a previous life.
              </h2>
            </header>
            <p>
